...
public class GupshupMock {
    ...
    public String getMockedEmailResponse(String mail_id) {
        return EMAIL_MOCKED_RESPONSES.get(mail_id);
    }

    public String getMockedSmsDeliveryStatus(String messageId) {
        return SMS_DELIVERY_STATUS_MOCKED_RESPONSES.get(messageId);
    }

    public String getMockedPushNotificationResponse(String token) {
